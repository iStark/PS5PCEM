<div align="center">
  ...
  <p>
    <a href="https://github.com/iStark/PS5PCEM/releases/tag/v0.3.1-beta.1"><img src="https://img.shields.io/github/v/release/iStark/PS5PCEM?include_prereleases&style=flat-square&color=3b95ff" alt="Latest release"></a>
  ...
  <p>
    <a href="https://github.com/iStark/PS5PCEM/releases/tag/v0.3.1-beta.1"><strong>Download prototype</strong></a>
...
The current Windows x64 prototype is **0.3.1-beta.1**:

- [Portable ZIP](https://github.com/iStark/PS5PCEM/releases/download/v0.3.1-beta.1/PS5PCEM-0.3.1-beta.1-windows-x64-portable.zip)
- [Per-user installer](https://github.com/iStark/PS5PCEM/releases/download/v0.3.1-beta.1/PS5PCEM-0.3.1-beta.1-windows-x64-setup.exe)
- [SHA-256 checksums](https://github.com/iStark/PS5PCEM/releases/download/v0.3.1-beta.1/SHA256SUMS.txt)
- [Release notes](docs/release-notes/v0.3.1-beta.1.md)
...
| [Release notes](docs/release-notes/v0.3.1-beta.1.md) | Changes in the latest packaged prototype |
