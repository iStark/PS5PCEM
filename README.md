<div align="center">
  ...
  <p>
    <a href="https://github.com/iStark/PS5PCEM/releases/tag/v0.3.2"><img src="https://img.shields.io/github/v/release/iStark/PS5PCEM?include_prereleases&style=flat-square&color=3b95ff" alt="Latest release"></a>
  ...
  <p>
    <a href="https://github.com/iStark/PS5PCEM/releases/tag/v0.3.2"><strong>Download prototype</strong></a>
...
The launcher remembers up to 32 recent titles across pages of eight, reads artwork
from each title's local `sce_sys/icon0.png`, detects DualSense and DualShock controllers,
...
The current Windows x64 prototype is **0.3.2**:

- [Portable ZIP](https://github.com/iStark/PS5PCEM/releases/download/v0.3.2/PS5PCEM-0.3.2-windows-x64-portable.zip)
- [Per-user installer](https://github.com/iStark/PS5PCEM/releases/download/v0.3.2/PS5PCEM-0.3.2-windows-x64-setup.exe)
- [SHA-256 checksums](https://github.com/iStark/PS5PCEM/releases/download/v0.3.2/SHA256SUMS.txt)
- [Release notes](docs/release-notes/v0.3.2.md)

The prototype requires Windows 10 2004 or newer, an x86-64-v3 CPU (AVX2, BMI2
and FMA), and a current Vulkan 1.2-capable graphics driver. The applications and
installer carry SHA-256 Authenticode signatures and timestamps from
`CN=Artur Strazewicz, O=PS5PCEM`. This certificate is self-signed, so Windows may
still display an Unknown Publisher or Microsoft Defender SmartScreen warning.
...
| [Release notes](docs/release-notes/v0.3.2.md) | Changes in the latest packaged prototype |
