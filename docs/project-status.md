...
| **Big Helmet Heroes**<br><img src="images/big-helmet-heroes-intro.png" width="240" alt="Big Helmet Heroes opening movie playing in PS5PCEM"> | **Intro playback · black screen after the intro · not playable** | The opening movie completes, then the screen remains black, as reported by the maintainer on September 18, 2026. Corrected NAPS mapping and Kraken decoding restore the application tree, including all ten UE PAK archives. Menu and gameplay have not been reached. [Intro capture](images/big-helmet-heroes-intro.png) |
...
from PS5PCEM's live 1920×1080 presentation output. The maintainer reports that
the movie completes, but the following screen stays black. Menu and gameplay
are not available at this milestone.*
