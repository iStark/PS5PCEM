...
fn classify(inst: instruction.Instruction) struct { Operation, ValueType } {
    return switch (inst.opcode) {
        ...
        => .{ .memory, .bits32 },
        .image_load, .image_load_mip, .image_store, .image_store_mip, .image_get_resinfo, .image_get_lod, .image_atomic_add, .image_atomic_umin, .image_atomic_umax, .image_atomic_and, .image_atomic_or, .image_atomic_xor, .image_atomic_fmax, .image_sample, .image_gather4 => .{ .image, .bits32 },
